...
Sub Suivi()
    ...
    Tableau_Nomenclatures_PremLigne = 2
    Tableau_Nomenclatures_PremColonne = 2
    ...
    Tableau_GDP06 = Feuille_Feuil1.Range(Cells(1, 1), Cells(Tableau_GDP06_DerLigne, Tableau_GDP06_DerColonne)).Value 'La lecture du tableau se fait en une seule fois par cette commande
        ...
        'La condition vérifie que la sélection est cochée pour l'affaire voulue
            ...
            'Cette boucle s'arrête quand toutes les nomenclatures de la ligne ont été parcourues
                ...
                'La condition vérifie que les cellules des colonnes Nomenclatures ne sont pas vides
                    ...
                    Tableau_Nomenclature = Feuille_Nomenclature.Range(Cells(2, 1), Cells(Tableau_Nomenclature_DerLigne, Tableau_Nomenclature_nColonneLocalisation)).Value
